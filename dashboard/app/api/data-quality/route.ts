...
/**
 * Proxy route handler for /dashboard/data_quality.json
 *
...
export async function GET(request: NextRequest) {
  ...
  // Pass through supported params (multi-value for status/category)
  ...
  categories.forEach((c) => backendParams.append("category", c));
  ...
  const url = `${BACKEND_BASE_URL}/dashboard/data_quality.json${queryString ? `?${queryString}` : ""}`;
