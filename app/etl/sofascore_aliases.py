...
SOFASCORE_OVERRIDES: dict[int, list[str]] = {
    ...
    # Keys = API-Football external_id (verified against teams table 2026-02-25)
    1137: ["Atletico Nacional", "Atlético Nacional"],
    1138: ["America de Cali", "América de Cali"],
    1139: ["Independiente Santa Fe", "Santa Fe"],
    1135: ["Junior", "Junior FC", "Junior de Barranquilla", "Junior Barranquilla"],
    1128: ["Independiente Medellin", "Independiente Medellín"],
    1142: ["Deportes Tolima", "Tolima"],
    1126: ["Deportivo Pasto", "Pasto"],
    1131: ["Bucaramanga", "Atlético Bucaramanga", "Atletico Bucaramanga"],
    1134: ["La Equidad", "Deportivo La Equidad", "Internacional de Bogotá", "Internacional de Bogota"],
    1132: ["Chico", "Boyacá Chicó", "Boyacá Chicó FC", "Chicó FC", "Chico FC"],
    1133: ["Jaguares", "Jaguares de Córdoba", "Jaguares de Cordoba"],
    1144: ["Águilas Doradas", "Aguilas Doradas", "Rionegro Aguilas", "Rionegro Águilas Doradas"],
    1140: ["Patriotas", "Patriotas Boyaca", "Patriotas Boyacá"],
    1141: ["Alianza Petrolera", "Alianza FC", "Alianza Valledupar", "Alianza Valledupar FC"],
    1129: ["Envigado", "Envigado FC"],
    1136: ["Once Caldas"],
    1465: ["Union Magdalena", "Unión Magdalena"],
    1464: ["Llaneros", "Llaneros FC"],
    1470: ["Cucuta", "Cúcuta Deportivo", "Cucuta Deportivo"],
    1146: ["Cortulua", "Cortuluá", "Internacional de Palmira"],
    1130: ["Huila", "Atlético Huila", "Atletico Huila", "Independiente Yumbo"],
    1462: ["Deportivo Pereira", "Pereira"],
